...
export function drawChart3_1() {
    ...
    const svg = d3.select("#pi-0-ratio")
        .attr("width", width)
        .attr("height", height)
    .append("g")
    ...
    // Create dummy data
    const data = {rejector:8,acceptor:230}
...
export function drawChart3_2() {
    ...
    const svg = d3.select("#pi-1-ratio")
        .attr("width", width)
        .attr("height", height)
    .append("g")
        .attr("transform", `translate(${width/2},${height/2})`);
    ...
    // Create dummy data
    const data = {rejector:65,acceptor:109}
